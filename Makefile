...
validate: .PHONY
	...
	docker exec clab-observability-spine1 vtysh -c "show bgp summary"
	@echo "Validating BGP neighbors on leaf1..."
	docker exec clab-observability-leaf1 vtysh -c "show bgp summary"
	@echo "Validating BGP neighbors on leaf2..."
	docker exec clab-observability-leaf2 vtysh -c "show bgp summary"
